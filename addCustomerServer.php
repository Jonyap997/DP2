<?php
    ...
    if(isset($_POST['add_customer_submit'])) {
        ...
        $gender = $_POST['gender'];
        $dob = $_POST['dob'];
        $date=date("Y-m-d H:i:s",strtotime($dob));
        ...
        $query = "INSERT INTO customers (fullname, gender, dob, countryCode, phoneNumber, dateRegistered) VALUES ('$fullname', '$gender', '$date', '$countryCode', '$phoneNumber', CURRENT_DATE())";
